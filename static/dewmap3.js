...
var legend_labels = ["No activity", "Limited activity, <1.0", "Industrial activity, 1-5","Growing activity, 5-50", "Regional exporter, 50+"]
var colors =(['white','#ffffcc','#addd8e','#41ab5d','#005a32']);
